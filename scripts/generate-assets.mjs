#!/usr/bin/env node
/**
 * Generates every brand asset for Memoflip from one source of truth: the mark below.
 *
 ...
 */
const SHAPES = [{"type":"rect","x":0.07,"y":0.15,"w":0.36,"h":0.7,"r":0.09,"fill":"accentMid"},{"type":"circle","cx":0.25,"cy":0.39,"r":0.065,"fill":"ink"},{"type":"circle","cx":0.25,"cy":0.61,"r":0.065,"fill":"ink"},{"type":"poly","points":[[0.56,0.19],[0.72,0.15],[0.72,0.85],[0.56,0.81]],"fill":"accent"},{"type":"poly","points":[[0.78,0.15],[0.93,0.19],[0.93,0.81],[0.78,0.85]],"fill":"accentLight"}];
 ...
 */
const MARK = [[1,1,0.12,1,1],[1,1,0.12,1,1],[0.12,0.12,0.12,0.12,0.12],[1,0.45,0.12,0.45,1],[1,0.45,0.12,0.45,1]];
...
console.log('Generating Memoflip brand assets\n');
