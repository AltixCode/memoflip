...
`apps.json`). Fix it there and re-run `node scripts/bootstrap.mjs memoflip`,
...
| | |
|---|---|
| Bundle id / package | `com.altixcode.memoflip` |
| Scheme | `memoflip://` |
| RevenueCat entitlement | `remove_ads` |
| RevenueCat package | `$rc_lifetime` |
| iOS product | `com.altixcode.memoflip.removeads` |
| Android product | `remove_ads` |
| GitHub | `AltixCode/memoflip` |
