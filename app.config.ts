...
/**
 * Store identity and native configuration for Memoflip.
 *
...
const TRACKING_USAGE =
  'This lets us show you ads that are more relevant to you. Your data is never sold, and Memoflip works exactly the same either way.';
...
const config: ExpoConfig = {
  ...
  assetBundlePatterns: ['**/*'],
  ios: {
    bundleIdentifier: 'com.altixcode.memoflip',
    buildNumber: BUILD,
    supportsTablet: true,
  ...
  android: {
    package: 'com.altixcode.memoflip',
